...
class ArrayWork{
    ...
    init(){
        ...
        list.append(workout(image: "jump", WorkText: "Jumping Jacks", promptText:
            "1. Stand with legs straight and arm by your sides 2. Jump up and spread feet beyond hip-width apart 3. Bring arms above head 4. Jump again, lower arm, bring legs together 5. Return to starting position", typeText: "Exercise", timer: "\(exerciseDuration)", goTimer: exerciseDuration, Numb: 0))
        ...
        list.append(workout(image: "situp", WorkText: "Push Up", promptText:
            "1. Hands on the floor 2. Shoulder width apart 3. Engage your core 4. Exhale when lowering your chest 5. Inhale when push back up 6. Maintain flat back", typeText: "Exercise", timer: "\(coolDownDuration)", goTimer: coolDownDuration, Numb: 1))
        list.append(workout(image: "situp", WorkText: "Rest", promptText:
            "", typeText: "Rest", timer: "\(restDuration)", goTimer: restDuration, Numb: 1))
        
        // MARK: - Plank
        list.append(workout(image: "situp", WorkText: "Plank", promptText:
            "1. Get into a push up position 2. Keep palms and toes on ground 3. Keep back straight, core muscles tight 4. Don’t let your head or back sag towards the floors 5. Hold plank throughout the duration", typeText: "Exercise", timer: "\(exerciseDuration)", goTimer:exerciseDuration, Numb: 2))
        list.append(workout(image: "situp", WorkText: "Rest", promptText:
        ...
        list.append(workout(image: "situp", WorkText: "Air Swimming", promptText:
            "1. Lie on stomach with arms extended 2. Lift chest, arms and legs 3. Squeeze your glutes 4. Flutter arms and legs while not touching the floor", typeText: "Exercise", timer: "\(exerciseDuration)", goTimer: exerciseDuration, Numb: 3))
        list.append(workout(image: "situp", WorkText: "Rest", promptText:
        ...
        list.append(workout(image: "situp", WorkText: "Half Push Up", promptText:
            "1. Hands on the floor 2. Shoulder width apart 3. Knees on floor 4. Exhale when lowering your chest 5. Inhale when push back up", typeText: "Exercise", timer: "\(exerciseDuration)", goTimer: exerciseDuration, Numb: 5))
        list.append(workout(image: "situp", WorkText: "Rest", promptText:
        ...
        list.append(workout(image: "situp", WorkText: "Shoulder Stretch", promptText:
            "1. Feet slightly wider than shoulder width apart 2. Knees slightly bent 3. Place right arm parallel to the ground across your chest 4. Bend left arm up and use forearm to ease right arm 5. Closer to chest", typeText: "Cool Down", timer: "\(coolDownDuration)", goTimer: coolDownDuration, Numb: 1))
    }
}
