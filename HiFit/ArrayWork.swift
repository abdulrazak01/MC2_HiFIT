...
class ArayWork{
   ...
   var list = [workout]()
    ...
    init(){
        ...
        list.append(workout(image: "situp", WorkText: "Rest", promptText:
        "", typeText: "Rest", timerr: "40", goTimer: 20))
        
        list.append(workout(image: "situp", WorkText: "Reverse Lunge with Left Leg", promptText:
                                       "1. Stand with feet shoulder-width apart 2. Step your left foot behind bending your knees 3. Push through the heel of left foot to stand up 4. Repea", typeText: "Exercise", timerr: "20", goTimer: 20))
        
        list.append(workout(image: "situp", WorkText: "Rest", promptText:
              "", typeText: "Rest", timerr: "40", goTimer: 40))
        
        list.append(workout(image: "situp", WorkText: "Reverse Lunge with Right Leg", promptText:
                                              "1. Stand with feet shoulder-width apart 2. Step your right foot behind bending your knees 3. Push through the heel of right foot to stand up 4. Repeat", typeText: "Exercise", timerr: "20", goTimer: 20))
        
        list.append(workout(image: "situp", WorkText: "Rest", promptText:
        "", typeText: "Rest", timerr: "40", goTimer: 40))
        
        list.append(workout(image: "situp", WorkText: "Shoulder Circles", promptText:
        "", typeText: "Cool Down", timerr: "30", goTimer: 30))
