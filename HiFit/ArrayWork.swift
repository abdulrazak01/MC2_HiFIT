...
class ArrayWork{
    ...
    init(){
        ...
        list.append(workout(image: "situp", WorkText: "Push Up", promptText:
            "1. Hands on the floor 2. Shoulder width apart 3. Engage your core 4. Exhale when lowering your chest 5. Inhale when push back up 6. Maintain flat back", typeText: "Exercise", timer: "\(coolDownDuration)", goTimer: coolDownDuration, Numb: 1,Statuss: "Off"))
        list.append(workout(image: "situp", WorkText: "Rest", promptText:
            "", typeText: "Rest", timer: "\(restDuration)", goTimer: restDuration, Numb: 1,Statuss: "Off"))
        
        // MARK: - Plank
        list.append(workout(image: "situp", WorkText: "Plank", promptText:
            "1. Get into a push up position 2. Keep palms and toes on ground 3. Keep back straight, core muscles tight 4. Don’t let your head or back sag towards the floors 5. Hold plank throughout the duration", typeText: "Exercise", timer: "\(exerciseDuration)", goTimer:exerciseDuration, Numb: 2,Statuss: "Off"))
        list.append(workout(image: "situp", WorkText: "Rest", promptText:
            "", typeText: "Rest", timer: "\(restDuration)", goTimer: restDuration, Numb: 2,Statuss: "Off"))
        
        // MARK: - Air Swimming
        list.append(workout(image: "situp", WorkText: "Air Swimming", promptText:
            "1. Lie on stomach with arms extended 2. Lift chest, arms and legs 3. Squeeze your glutes 4. Flutter arms and legs while not touching the floor", typeText: "Exercise", timer: "\(exerciseDuration)", goTimer: exerciseDuration, Numb: 3,Statuss: "Off"))
        list.append(workout(image: "situp", WorkText: "Rest", promptText:
            "", typeText: "Rest", timer: "\(restDuration)", goTimer: restDuration, Numb: 3,Statuss: "Off"))
        
        // MARK: - Jump Squat
        list.append(workout(image: "situp", WorkText: "Jump Squat", promptText:
            "1. Stand with feet shoulder-width apart 2. Toes slightly turned out, hands in front of chest 3. When lowering, engage core, chest lifted and flat back 4. Maintain posture and jump as high as you can 5. Swinging arms down by your sides for momentum 6. Land softly, avoid knees from moving inwards", typeText: "Exercise", timer: "\(exerciseDuration)", goTimer: exerciseDuration, Numb: 4,Statuss: "Off"))
        list.append(workout(image: "situp", WorkText: "Rest", promptText:
            "", typeText: "Rest", timer: "\(restDuration)", goTimer: restDuration, Numb: 4,Statuss: "Off"))
        
        // MARK: - Half Push Up
        list.append(workout(image: "situp", WorkText: "Half Push Up", promptText:
            "1. Hands on the floor 2. Shoulder width apart 3. Knees on floor 4. Exhale when lowering your chest 5. Inhale when push back up", typeText: "Exercise", timer: "\(exerciseDuration)", goTimer: exerciseDuration, Numb: 5,Statuss: "Off"))
        list.append(workout(image: "situp", WorkText: "Rest", promptText:
            "", typeText: "Rest", timer: "\(restDuration)", goTimer: restDuration, Numb: 5,Statuss: "Off"))
        
        // MARK: - Pike Push Up
        list.append(workout(image: "situp", WorkText: "Pike Push Up", promptText:
            "1. Get into a push up position 2. Form a triangle by raising your glutes and moving feet inwards 3. Bend elbows and lower your shoulder to the ground 4. Allow forehead to very lightly contact the ground 5. Push upwards and back to starting position", typeText: "Exercise", timer: "\(exerciseDuration)", goTimer: exerciseDuration, Numb: 6,Statuss: "Off"))
        list.append(workout(image: "situp", WorkText: "Rest", promptText:
            "", typeText: "Rest", timer: "\(restDuration)", goTimer: restDuration, Numb: 6,Statuss: "Off"))
        
        // MARK: - Shoulder Stretch
        list.append(workout(image: "situp", WorkText: "Shoulder Stretch", promptText:
            "1. Feet slightly wider than shoulder width apart 2. Knees slightly bent 3. Place right arm parallel to the ground across your chest 4. Bend left arm up and use forearm to ease right arm 5. Closer to chest", typeText: "Cool Down", timer: "\(coolDownDuration)", goTimer: coolDownDuration, Numb: 1,Statuss: "Off"))
    }
}
